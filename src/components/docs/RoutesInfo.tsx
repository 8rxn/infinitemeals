      ...
      <div>
        <ul className="text-lg sm:text-xl flex flex-col sm:grid grid-cols-2 justify-between gap-4">
          ...
          <Card>
            ...
            <p className="font-light">Adds the recipe generated by AI to the database and cache</p>
          </Card>
          <Card>
            <div className="flex w-full justify-between mb-2">
              <span>POST</span>{" "}
            ...
            <p className="font-light">Searches for the image in the cache and database for a recipe</p>
          </Card>
          <Card>
            <div className="flex w-full justify-between mb-2">
              <span>POST</span>{" "}
          ...
          <Card>
            ...
            <p className="font-light">
            <span className="font-semibold">[unused]</span> Uses DALL - E to create images for food Items based on the search
              query 
            </p>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <p className="font-light">Gets the list of all tags present in the database</p>
          </Card>
          <Card>
            <div className="flex w-full justify-between mb-2">
              <span>POST</span>{" "}
          ...
          <Card>
            ...
            <p className="font-light">Uses Open AI API to generate a recipe for the given tag</p>
          </Card>
        </ul>
      </div>
    </div>
